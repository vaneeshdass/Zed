...
if os.name == "nt":
    ...
    lib = CDLL("/home/docker/zed-yolo/libdarknet/libdarknet.so", RTLD_GLOBAL)
...
def main(argv):
    thresh = 0.25
    darknet_path = "/home/docker/zed-yolo/libdarknet/"
    ...
    while key != 113:  # for 'q' key
        ...
        if err == sl.ERROR_CODE.SUCCESS:
            ...
            for detection in detections:
                ...
                boundingBox = [[xCoord, yCoord], [xCoord, yCoord + yExtent], [xCoord + xEntent, yCoord + yExtent],
                ...
                cv2.rectangle(image, (xCoord - thickness, yCoord - thickness),
                              (xCoord + xEntent + thickness, yCoord + (18 + thickness * 4)), color_array[detection[3]],
                              -1)
